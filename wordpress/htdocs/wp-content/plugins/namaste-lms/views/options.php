<div class="wrap">
	...
	<form method="post" class="namaste-form">
		<div class="postbox wp-admin namaste-box">
			...
			<input type="text" size="30" name="allowed_file_types" value="<?php echo get_option('namaste_allowed_file_types');?>" placeholder="Example: zip, doc, pdf"><br>
			...
			<p><?php _e('Use custom protected folder:', 'namaste');?> <input type="text" name="protected_folder" value="<?php echo get_option('namaste_protected_folder');?>" placeholder="<?php _e('Example: namaste_homework', 'namaste');?>">
			...
			<p><input type="submit" name="save_homework_options" value="<?php _e('Save homework settings', 'namaste')?>"></p>
		</div>
