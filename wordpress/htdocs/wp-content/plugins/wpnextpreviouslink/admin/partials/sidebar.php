...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        <div class="postbox">
            <h3><?php esc_html_e('Plugin Information','wpnextpreviouslink'); ?></h3>
            <div class="inside">
                ...
                <p>Facebook : <a href="http://facebook.com/codeboxr" target="_blank">fb.com/codeboxr</a></p>
        ...
        <div class="postbox">
            <h3><?php esc_html_e('Help & Supports','wpnextpreviouslink'); ?></h3>
            <div class="inside">
        ...
        <div class="postbox">
            <h3><?php esc_html_e('Codeboxr Updates','wpnextpreviouslink'); ?></h3>
            <div class="inside">
                <?php
        ...
        <div class="postbox">
            <h3><?php esc_html_e('Other Wordpress Plugins','wpnextpreviouslink'); ?></h3>
        ...
        <div class="postbox">
            <h3><?php esc_html_e('Codeboxr on facebook','wpnextpreviouslink'); ?></h3>
